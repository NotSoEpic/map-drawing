...
public class CompassWidget extends AbstractWidget {
    ...
    private final TextureAtlasSprite COMPASS = Minecraft.getInstance().getGuiSprites().getSprite(WayfinderClient.id("compass/compass"));
    private final ResourceLocation POINTER = WayfinderClient.id("textures/gui/sprites/compass/pointer.png");
