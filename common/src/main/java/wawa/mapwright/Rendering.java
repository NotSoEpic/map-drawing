...
public class Rendering {
	...
	public static class Textures {
		...
		private static final ResourceLocation BACKGROUND = MapwrightClient.id("background");
		private static final ResourceLocation BACKGROUND_FULL = MapwrightClient.id("textures/gui/sprites/background.png");
	}
